    ...
    <div class="panel panel-default" data-collapsed="0"
      style="border-color: #dedede;">
        ...
        <p style="font-size: 14px;">
          Welcome to admin user Management System Installation. You will need to know the following items before
          proceeding.
        </p>
        <ol>
        ...
        <p style="font-size: 14px;">
          ...
          (<strong>application/config/constants.php</strong>, <strong>application/config/database.php</strong> & <strong>application/config/routes.php</strong>) have
