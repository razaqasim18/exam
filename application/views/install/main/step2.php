    ...
    <div class="panel panel-default" data-collapsed="0"
      ...
      <div class="panel-body" style="font-size: 14px;">
        <p style="font-size: 14px;">
          Provide your codecanyon <strong>Buyer Name</strong> & <strong>Purchase Code</strong>
        </p>
        <br>
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal form-groups" method="post"
              action="<?php echo base_url();?>install/validate_purchase_code">

              <div class="form-group">
                <label class="col-sm-3 control-label">Buyer Name</label>
                <div class="col-sm-7">
                  <input type="text" class="form-control" name="buyer_name" placeholder="Envato Purchase Buyer name"
