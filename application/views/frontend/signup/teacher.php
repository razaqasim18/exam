<?php 
    ...
    $subject_list    = getSubjects($subject);
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <hr>
                <form class="form-horizontal" action="<?php echo base_url(); ?>signup/saveteacher" method="post" >
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12 ">
                                <p class="text-center"><b><?php echo getlang('site_academic_info', 'data'); ?></b></p>
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <?php  echo fieldBuilder('select', 'class', $class_list, getlang('site_form_class', 'data'), 'required'); ?>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <?php  echo fieldBuilder('select', 'department', $department_list, getlang('site_form_department', 'data'), 'required'); ?>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-8 col-md-offset-2"> 
                                <?php  echo fieldBuilder('select', 'year', $subject_list, getlang('site_form_subject', 'data'), 'required'); ?>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="submit" class="btn btn-primary" value="<?php echo getlang('site_btn_submit'); ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    window.asd = jQuery('.subjectfield').SumoSelect({search: true, searchText: '<?php echo getlang("site_select_here"); ?>'});
</script>
