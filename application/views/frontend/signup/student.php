    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <hr>
                <form class="form-horizontal" action="<?php echo base_url(); ?>signup/savestudent" method="post" >
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2"> 
                                <?php  echo fieldBuilder('select', 'year', $year_field, getlang('site_form_year', 'data'), 'required'); ?>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-8 col-md-offset-2"> 
                                <?php  echo fieldBuilder('input', 'roll', '', getlang('site_form_roll', 'data'), 'required'); ?>
                            </div>
                        </div>
