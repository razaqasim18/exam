            ...
            <form role="form" id="addUser" class="form-horizontal" action="<?php echo base_url(); ?>user/account" method="post" role="form" enctype="multipart/form-data">
                <div class="box-body">
                	<ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#profile"> <?php echo getlang('profile'); ?></a></li>
                        <li class=""><a data-toggle="tab" href="#account"> <?php echo getlang('account'); ?></a></li>
                        <li><a data-toggle="tab" href="#changepass"> <?php echo getlang('site_change_password', 'sys_data'); ?></a></li>
                        <li><a data-toggle="tab" href="#photo"> <?php echo getlang('site_change_photo', 'sys_data'); ?></a></li>
                        <li><a data-toggle="tab" href="#activity"> <?php echo getlang('site_login_activity', 'sys_data'); ?></a></li>
                     </ul>
