    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-8 title-bar">
                <h1>
                    <i class="fa fa-th-large"></i> <?php echo getlang('title_academic_courses', 'sys_data'); ?>
                    <small><?php echo getlang('add_edit_delete', 'sys_data'); ?></small>
                </h1>
            </div>

            <div class="col-xs-12 col-md-4 text-right">
                <a class="btn btn-primary" href="<?php echo base_url() . ADMIN_ALIAS; ?>/courses/add"><i class="fa fa-plus"></i> <?php echo getlang('btn_add', 'sys_data'); ?></a>
            </div>
        </div>
            ...
            <div class="col-xs-12 rms-data-table">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><?php echo getlang('courses_list', 'sys_data'); ?></h3>
                        <div class="box-tools">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover rms-table">
                            <tr>
                                ...
                                <th><?php echo getlang('course_name', 'sys_data'); ?></th>
                                <th><?php echo getlang('course_code', 'sys_data'); ?></th>
                                <th class="text-center" width="100px"><?php echo getlang('action', 'sys_data'); ?></th>
                               
                            </tr>
                            <?php
                            if (!empty($coursesRecords)) {
                                foreach ($coursesRecords as $record) {
                            ?>
                                    <tr>
                                        <td><?php echo getNameById($record->class_id, 'class'); ?></td>
                                        <td><?php echo getSubjectNameCode($record->subject_id, 'subjects'); ?></td>
                                        <td><?php echo $record->name; ?></td>
                                        <td><?php echo $record->code; ?></td>
                                    
                                        <td class="text-center">
                                            <a class="btn btn-sm btn-info" href="<?php echo base_url() . ADMIN_ALIAS . '/courses/add/' . $record->id; ?>" title="<?php echo getlang('edit', 'sys_data'); ?>"><i class="fa fa-pencil"></i></a>
                                            <a class="btn btn-sm btn-danger deleteCourse" data-id="<?php echo $record->id; ?>" id="classId" href="#" name="Id" title="<?php echo getlang('delete', 'sys_data'); ?>"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                            <?php
                                }
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        jQuery(document).on("click", ".deleteCourse", function() {
            var Id = $(this).data("id"),
                hitURL = baseURL + "<?php echo ADMIN_ALIAS; ?>/courses/delete",
                currentRow = $(this);
