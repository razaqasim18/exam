    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-8 title-bar">
                <h1>
                    <i class="fa fa-graduation-cap"></i> <?php echo getlang('title_academic_exam', 'sys_data'); ?>
                    <small><?php echo getlang('add_edit_delete', 'sys_data'); ?></small>
                </h1>
            </div>

            <div class="col-xs-12 col-md-4 text-right">
                <a class="btn btn-primary" href="<?php echo base_url() . ADMIN_ALIAS; ?>/exams/add"><i class="fa fa-plus"></i> <?php echo getlang('btn_add', 'sys_data'); ?></a>
            </div>
        </div>
            ...
            <div class="col-xs-12 rms-data-table">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><?php echo getlang('exam_list', 'sys_data'); ?></h3>
                        <div class="box-tools">
                            <form action="<?php echo base_url() . ADMIN_ALIAS; ?>/exams" method="POST" id="searchList">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            <tr>
                                <th><?php echo getlang('exam_name', 'sys_data'); ?></th>
                                <th><?php echo getlang('department', 'sys_data'); ?></th>
                                <th><?php echo getlang('class', 'sys_data'); ?></th>
                                <th><?php echo getlang('semester', 'sys_data'); ?></th>
                                <th>Term</th>
                                <th>Exam Type</th>
                                <th><?php echo getlang('exam_date', 'sys_data'); ?></th>                                                            

                                <th style="text-align: center;" width="120px"><?php echo getlang('action', 'sys_data'); ?></th>                                
                            </tr>
                                ...
                                foreach ($examRecords as $record) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm btn-info" href="<?php echo base_url() . ADMIN_ALIAS . '/exams/add/' . $record->id; ?>" title="<?php echo getlang('edit', 'sys_data'); ?>"><i class="fa fa-pencil"></i></a>
                                            <a class="btn btn-sm btn-danger deleteExam" data-id="<?php echo $record->id; ?>" id="examId" href="#" title="<?php echo getlang('delete', 'sys_data'); ?>"><i class="fa fa-trash"></i></a>
                                        </td>                                        
                                    </tr>
                            <?php }
                            }  ?>
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        jQuery(document).on("click", ".deleteExam", function() {
            var Id = $(this).data("id"),
                hitURL = baseURL + "<?php echo ADMIN_ALIAS; ?>/exams/delete",
                currentRow = $(this);
