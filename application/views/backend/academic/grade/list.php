    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-6 title-bar">
            	<h1>
                    <i class="fa fa-list-alt"></i> <?php echo getlang('title_academic_grade', 'sys_data'); ?> 
                    <small><?php echo getlang('add_edit_delete', 'sys_data'); ?></small>
                </h1>
            </div>

            <div class="col-xs-12 col-md-6 text-right">
            	<a class="btn btn-primary" href="<?php echo base_url().ADMIN_ALIAS; ?>/grade/add"><i class="fa fa-plus"></i> <?php echo getlang('btn_add', 'sys_data'); ?></a>
            </div>
        </div>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
	                    ...
	                    <form action="<?php echo base_url().ADMIN_ALIAS; ?>/grade" method="POST" id="searchList">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover rms-table">
                            <tr class="odd">
                                <th><?php echo getlang('grade_name', 'sys_data'); ?></th>
                                <th><?php echo getlang('gcat_name', 'sys_data'); ?></th>
                                <th><?php echo getlang('grade_point', 'sys_data'); ?></th>
                                <th><?php echo getlang('mark_from', 'sys_data'); ?></th>
                                <th><?php echo getlang('mark_upto', 'sys_data'); ?></th>
                                <th><?php echo getlang('comment', 'sys_data'); ?></th>
                            ...
                            <?php  foreach ($data as $key => $item) { ?>
                                <tr >
                                    ...
                                    <td><?php echo $item->grade_point; ?></td>
                                    <td><?php echo $item->mark_from; ?></td>
                                    <td><?php echo $item->mark_upto; ?></td>
                                    ...
                                    <td class="text-center">
                                       <a class="btn btn-sm btn-info" href="<?php echo base_url().ADMIN_ALIAS.'/grade/add/'.$item->id; ?>" title="<?php echo getlang('edit', 'sys_data'); ?>"><i class="fa fa-pencil"></i></a>
                                        <a class="btn btn-sm btn-danger deleteGrade" data-id="<?php echo $item->id; ?>" id="categoryId" href="#"  title="<?php echo getlang('delete', 'sys_data'); ?>"><i class="fa fa-trash"></i></a>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "<?php echo ADMIN_ALIAS; ?>/grade/" + value);
        ...
        **/
        jQuery(document).on("click", ".deleteGrade", function(){
            var Id = $(this).data("id"),
            hitURL = baseURL + "<?php echo ADMIN_ALIAS; ?>/grade/delete",
            currentRow = $(this);
