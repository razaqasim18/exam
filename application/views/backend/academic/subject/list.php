    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-8 title-bar">
                <h1><i class="fa fa-book"></i> <?php echo getlang('title_academic_subject', 'sys_data'); ?>
                    <small><?php echo getlang('add_edit_delete', 'sys_data');?></small>
                </h1>
            </div>

            <div class="col-xs-12 col-md-4 text-right">
                <a class="btn btn-primary" href="<?php echo base_url().ADMIN_ALIAS; ?>/subjects/add"><i class="fa fa-plus"></i> <?php echo getlang('btn_add', 'sys_data'); ?></a>
            </div>
        </div>
            ...
            <div class="col-xs-12 rms-data-table">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><?php echo getlang('subject_list', 'sys_data'); ?></h3>
                        <div class="box-tools">
                            <form action="<?php echo base_url().ADMIN_ALIAS; ?>/subjects" method="POST" id="searchList">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            <tr>
                                ...
                                <th><?php echo getlang('subject_code', 'sys_data'); ?></th>
                                <th><?php echo getlang('subject_type', 'sys_data'); ?></th>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-sm btn-info" href="<?php echo base_url().ADMIN_ALIAS.'/subjects/add/'.$record->id; ?>" title="<?php echo getlang('edit', 'sys_data'); ?>"><i class="fa fa-pencil"></i></a>
                                    <a class="btn btn-sm btn-danger deleteSubject"data-id="<?php echo $record->id; ?>" id="subjectId" href="#"  title="<?php echo getlang('delete', 'sys_data');?>"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php
                                }
    ...
    jQuery(document).ready(function(){
        ...
        **/
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "subjects/" + value);
        ...
        **/
        jQuery(document).on("click", ".deleteSubject", function(){
            var Id = $(this).data("id"),
                hitURL = baseURL + "<?php echo ADMIN_ALIAS; ?>/subjects/delete",
                currentRow = $(this);
