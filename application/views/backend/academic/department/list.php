    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-8 title-bar">
                <h1>
                    <i class="fa fa-sitemap"></i> <?php echo getlang('title_academic_department', 'sys_data'); ?> 
                    <small><?php echo getlang('add_edit_delete', 'sys_data'); ?></small>
                </h1>
            </div>

            <div class="col-xs-12 col-md-4 text-right">
                <a class="btn btn-primary" href="<?php echo base_url().ADMIN_ALIAS; ?>/department/add"><i class="fa fa-plus"></i> <?php echo getlang('btn_add', 'sys_data'); ?></a>
            </div>
        </div>
            ...
            <div class="col-xs-12 rms-data-table">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><?php echo getlang('department_list', 'sys_data'); ?></h3>
                        <div class="box-tools">
                            <form action="<?php echo base_url().ADMIN_ALIAS; ?>/departments" method="POST" id="searchList">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-sm btn-info" href="<?php echo base_url().ADMIN_ALIAS.'/department/add/'.$record->id; ?>" title="<?php echo getlang('edit', 'sys_data'); ?>"><i class="fa fa-pencil"></i></a>
                                    <a class="btn btn-sm btn-danger deleteDepartment"data-id="<?php echo $record->id; ?>" id="subjectId" href="#"  title="<?php echo getlang('delete', 'sys_data'); ?>"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php
                                }
    ...
    jQuery(document).ready(function(){
        ...
        **/
        jQuery(document).on("click", ".deleteDepartment", function(){
            var Id = $(this).data("id"),
                hitURL = baseURL + "<?php echo ADMIN_ALIAS; ?>/department/delete",
                currentRow = $(this);
