...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-6 title-bar">
            	<h1><i class="fa fa-calculator"></i> <?php echo getlang('title_accountig', 'sys_data'); ?></h1>
            </div>
        </div>
    ...
    <script type="text/javascript">
        var months = ['<?php echo getlang('month_jan', 'sys_data');?>', '<?php echo getlang('month_feb', 'sys_data'); ?>', '<?php echo getlang('month_mar', 'sys_data'); ?>', '<?php echo getlang('month_apr', 'sys_data'); ?>', '<?php echo getlang('month_may'); ?>', '<?php echo getlang('month_jun', 'sys_data'); ?>', '<?php echo getlang('month_jul', 'sys_data'); ?>', '<?php echo getlang('month_aug', 'sys_data'); ?>', '<?php echo getlang('month_sep', 'sys_data'); ?>', '<?php echo getlang('month_oct', 'sys_data'); ?>', '<?php echo getlang('month_nov', 'sys_data'); ?>', '<?php echo getlang('month_dec', 'sys_data'); ?>'];
      $(function () {
        "use strict";
